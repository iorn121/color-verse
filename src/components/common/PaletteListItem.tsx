...
export default function PaletteListItem({
  ...
  title,
  description,
}: PropsWithChildren<PaletteListItemProps>) {
  ...
  return (
    <li style={liStyle}>
      <Link to={to} style={linkStyle} className="flex items-center">
        <h3 style={titleStyle} className="flex items-center">
          ...
          <span className="text-sm text-secondary-gradient-text">{title}</span>
        </h3>
